...
const About = () => {
  ...
  const skills = [
    ...
    { name: "JavaScript", percent: 90, icon: <FaJsSquare className="text-yellow-500" /> },
    ...
    { name: "Tailwind CSS", percent: 92, icon: <SiTailwindcss className="text-cyan-500" /> },
  ...
  return (
    <section id="about" className=" relative py-20 px-4 bg-white dark:bg-gray-900 overflow-hidden">
      {/* Bubble Background */}
      <div className={`bubble-container absolute inset-0 z-0 bubbles top-0 left-0 w-full h-full overflow-hidden z- ${isVisible ? "opacity-100" : "opacity-0"}`}>
      ...
      {/* Main Content */}
      <div className="relative z-0 max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10 " >
        {/* Left Image */}
        ...
        >
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
            Hello, I am <strong className="text-2xl">Nikhil Waghade</strong>.<br />
            "I'm dedicated to developing a cutting-edge, personalized learning platform — Connect Shiksha — designed to provide targeted remediation and tutoring solutions for learners seeking better outcomes." — <strong>Connect Shiksha & Excellup</strong>.
          </p>
          ...
          {/* Social Link */}
          <p className="text-lg text-indigo-500 font-semibold mt-6 mb-2">Connect With Me:</p>
<div className="flex items-center gap-6 mt-2 text-xl">
  <a
          ...
          <div key={index} className="mb-4">
            <div className="flex items-center justify-between mb-1">
              <div className="flex items-center gap-2">
                <span className="text-md font-medium text-gray-800 dark:text-gray-200">{skill.icon}</span>
                <span className="text-md font-medium text-gray-800 dark:text-gray-200">{skill.name}</span>
              </div>
